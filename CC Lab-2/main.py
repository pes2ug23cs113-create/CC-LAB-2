...
def events(request: Request, user: str):
    ...
    # OPTIMIZATION: Removed the 'waste' loop that ran 3,000,000 times
    # This directly reduces CPU time and response latency.

    return templates.TemplateResponse(
        "events.html",
        {"request": request, "events": rows, "user": user, "srn": SRN}
    )
...
def my_events(request: Request, user: str):
    ...
    # REMOVE THESE LINES FOR OPTIMIZATION:
    # dummy = 0
